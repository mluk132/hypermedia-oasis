        ...
        <div className="container-custom py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/create" className="text-purple-600 font-semibold">
                Create
              </Link>
              <Link href="/analytics" className="text-gray-700 hover:text-purple-600 transition-colors">
                Analytics
              </Link>
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 cursor-pointer"></div>
            </div>
          </div>
        </div>
      </nav>
              ...
              <div className="card p-6">
                ...
                <div className="flex gap-2 mb-3 flex-wrap">
                  {tags.map((tag) => (
                    <span 
                      key={tag}
                      className="px-3 py-1 bg-purple-100 text-indigo-700 rounded-full text-sm font-medium flex items-center gap-2"
                    >
                      #{tag}
                      <button 
